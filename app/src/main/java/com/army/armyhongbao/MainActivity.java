...
import com.army.armyhongbao.util.BitmapUtils;
...
public class MainActivity extends BaseSettingsActivity {
    ...
    private void showDonateDialog() {
        ...
        view.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                File output = new File(android.os.Environment.getExternalStorageDirectory(), "wechatpay_qr.jpg");
                if(!output.exists()) {
    ...
    public static class MainFragment extends BaseSettingsFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            notificationPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    ...
                    if(enalbe && !ArmyHongBaoService.isNotificationServiceRunning()) {
        ...
        public void updateNotifyPreference() {
            ...
            boolean running = ArmyHongBaoService.isNotificationServiceRunning();
